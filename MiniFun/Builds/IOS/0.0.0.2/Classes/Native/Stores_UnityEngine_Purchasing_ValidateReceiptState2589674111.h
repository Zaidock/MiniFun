...
struct  ValidateReceiptState_t2589674111 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ValidateReceiptState_t2589674111, ___value___1)); }
